    ...
    context(
      ...
      () => {
        context('static data', () => {
          ...
          it('- should correctly validate an email instance and throw appropriate errors when found', async () => {
            try {
              /////////////////////////
              //////// setup //////////
              /////////////////////////
              ...
              const validateResponse = email.validate();
              ...
              expect((validateResponse.value as any).from !== undefined).to.be.true;
              expect((validateResponse.value as any).from.name !== undefined).to.be.true;
              ...
              expect((validateResponse.value as any).text === EXPECTED_EMAIL_ADDRESS.text).to.be.true;
              expect((validateResponse.value as any).attachments !== undefined).to.be.true;
              expect((validateResponse.value as any).attachments instanceof EXPECTED_ARRAY_CLASS_INSTANCE).to.be.true;
              for (const item of (validateResponse.value as any).attachments) {
          ...
          it('- should correctly validate an email instance and throw appropriate errors when found (from)', async () => {
            try {
              /////////////////////////
              //////// setup //////////
              /////////////////////////
          ...
          it('- should correctly validate an email instance and throw appropriate errors when found (to)', async () => {
            try {
              /////////////////////////
              //////// setup //////////
              /////////////////////////
          ...
          it('- should correctly validate an email instance and throw appropriate errors when found (cc)', async () => {
            try {
              /////////////////////////
              //////// setup //////////
              /////////////////////////
          ...
          it('- should correctly validate an email instance and throw appropriate errors when found (bcc)', async () => {
            try {
              /////////////////////////
              //////// setup //////////
              /////////////////////////
          ...
          it('- should correctly validate an email instance and throw appropriate errors when found (subject)', async () => {
            try {
              /////////////////////////
              //////// setup //////////
              /////////////////////////
          ...
          it('- should correctly validate an email instance and throw appropriate errors when found (text)', async () => {
            try {
              /////////////////////////
              //////// setup //////////
              /////////////////////////
          ...
          it('- should correctly validate an email instance and throw appropriate errors when found (attachments)', async () => {
            try {
              /////////////////////////
              //////// setup //////////
              /////////////////////////
          ...
          it('- should correctly validate an email instance and throw appropriate errors when found (from, to, cc, bcc, subject, text, or attachments)', async () => {
            try {
              /////////////////////////
              //////// setup //////////
              /////////////////////////
        ...
        context('static data', () => {
          ...
          it('- should correctly validate an email instance and throw appropriate errors when found', async () => {
            try {
              ...
              expect((validateResponse.value as any).to instanceof EXPECTED_ARRAY_CLASS_INSTANCE).to.be.true;
              for (const item of (validateResponse.value as any).to) {
                const found = EXPECTED_EMAIL_ADDRESS.to.find((expectedItem: any) => expectedItem.address === item.address);
                expect(found !== undefined).to.be.true;
              }
              expect((validateResponse.value as any).cc !== undefined).to.be.true;
              expect((validateResponse.value as any).cc instanceof EXPECTED_ARRAY_CLASS_INSTANCE).to.be.true;
              for (const item of (validateResponse.value as any).cc) {
                const found = EXPECTED_EMAIL_ADDRESS.cc.find((expectedItem: any) => expectedItem.address === item.address);
                expect(found !== undefined).to.be.true;
              }
              expect((validateResponse.value as any).bcc !== undefined).to.be.true;
              expect((validateResponse.value as any).bcc instanceof EXPECTED_ARRAY_CLASS_INSTANCE).to.be.true;
              for (const item of (validateResponse.value as any).bcc) {
                const found = EXPECTED_EMAIL_ADDRESS.bcc.find((expectedItem: any) => expectedItem.address === item.address);
                expect(found !== undefined).to.be.true;
              }
              expect((validateResponse.value as any).subject !== undefined).to.be.true;
        ...
        context('static data', () => {
          ...
          it('- should correctly validate an email instance and throw appropriate errors when found', async () => {
            try {
              ...
              expect((validateResponse.value as any).subject !== undefined).to.be.true;
              expect((validateResponse.value as any).subject === EXPECTED_EMAIL_ADDRESS.subject).to.be.true;
              expect((validateResponse.value as any).html !== undefined).to.be.true;
              expect((validateResponse.value as any).html === EXPECTED_EMAIL_ADDRESS.html).to.be.true;
              expect((validateResponse.value as any).attachments !== undefined).to.be.true;
              expect((validateResponse.value as any).attachments instanceof EXPECTED_ARRAY_CLASS_INSTANCE).to.be.true;
              for (const item of (validateResponse.value as any).attachments) {
                const found = EXPECTED_EMAIL_ADDRESS.attachments.find((expectedItem: any) => expectedItem.path === item.path);
          ...
          it('- should correctly validate an email instance and throw appropriate errors when found (html)', async () => {
            try {
              /////////////////////////
              //////// setup //////////
              /////////////////////////
