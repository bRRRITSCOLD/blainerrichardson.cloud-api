        ...
        context('static data', () => {
          ...
          it('- should correctly asynchronously validate an email instance and throw appropriate errors when found', async () => {
            try {
              ...
              expect((validateAsyncResponse.value as any).to.name !== undefined).to.be.true;
              expect((validateAsyncResponse.value as any).to.name === EXPECTED_EMAIL_ADDRESS.to.name).to.be.true;
              expect((validateAsyncResponse.value as any).to.address !== undefined).to.be.true;
              expect((validateAsyncResponse.value as any).to.address === EXPECTED_EMAIL_ADDRESS.to.address).to.be.true;
              expect((validateAsyncResponse.value as any).cc !== undefined).to.be.true;
              expect((validateAsyncResponse.value as any).cc.name !== undefined).to.be.true;
              expect((validateAsyncResponse.value as any).cc.name === EXPECTED_EMAIL_ADDRESS.cc.name).to.be.true;
              expect((validateAsyncResponse.value as any).cc.address !== undefined).to.be.true;
              expect((validateAsyncResponse.value as any).cc.address === EXPECTED_EMAIL_ADDRESS.cc.address).to.be.true;
              expect((validateAsyncResponse.value as any).bcc !== undefined).to.be.true;
              expect((validateAsyncResponse.value as any).bcc.name !== undefined).to.be.true;
              expect((validateAsyncResponse.value as any).bcc.name === EXPECTED_EMAIL_ADDRESS.bcc.name).to.be.true;
              expect((validateAsyncResponse.value as any).bcc.address !== undefined).to.be.true;
              expect((validateAsyncResponse.value as any).bcc.address === EXPECTED_EMAIL_ADDRESS.bcc.address).to.be.true;
