  ...
  describe('#validate', () => {
    context('EmailAttachement({ path })', () => {
      context('static data', () => {
        ...
        it('- should correctly validate an email attachment instance and throw appropriate errors when found', async () => {
          try {
            /////////////////////////
            //////// setup //////////
            /////////////////////////
            ...
            const validateResponse = emailAttachment.validate();
            ...
            expect((validateResponse.value as any) instanceof EXPECTED_EMAIL_ATTACHEMENT_CLASS_INSTANCE).to.be.true;
            expect((validateResponse.value as any).path !== undefined).to.be.true;
            expect((validateResponse.value as any).path === EXPECTED_EMAIL_ATTACHEMENT.path).to.be.true;
        ...
        it('- should correctly validate an email attachment instance and throw appropriate errors when found (path)', async () => {
          try {
            /////////////////////////
            //////// setup //////////
            /////////////////////////
      ...
      context('static data', () => {
        ...
        it('- should correctly validate an email attachment instance and throw appropriate errors when found', async () => {
          try {
            ...
            expect((validateResponse.value as any) !== undefined).to.be.true;
            expect((validateResponse.value as any) instanceof EXPECTED_EMAIL_ATTACHEMENT_CLASS_INSTANCE).to.be.true;
            expect((validateResponse.value as any).filename !== undefined).to.be.true;
            expect((validateResponse.value as any).filename === EXPECTED_EMAIL_ATTACHEMENT.filename).to.be.true;
            expect((validateResponse.value as any).path !== undefined).to.be.true;
            expect((validateResponse.value as any).path === EXPECTED_EMAIL_ATTACHEMENT.path).to.be.true;
        ...
        it('- should correctly validate an email attachment instance and throw appropriate errors when found (filename)', async () => {
          try {
            /////////////////////////
            //////// setup //////////
            /////////////////////////
        ...
        it('- should correctly validate an email attachment instance and throw appropriate errors when found (filename or path)', async () => {
          try {
            /////////////////////////
            //////// setup //////////
            /////////////////////////
      ...
      context('static data', () => {
        ...
        it('- should correctly validate an email attachment instance and throw appropriate errors when found', async () => {
          try {
            ...
            expect((validateResponse.value as any).filename !== undefined).to.be.true;
            expect((validateResponse.value as any).filename === EXPECTED_EMAIL_ATTACHEMENT.filename).to.be.true;
            expect((validateResponse.value as any).content !== undefined).to.be.true;
            expect((validateResponse.value as any).content === EXPECTED_EMAIL_ATTACHEMENT.content).to.be.true;
        ...
        it('- should correctly validate an email attachment instance and throw appropriate errors when found (content)', async () => {
          try {
            /////////////////////////
            //////// setup //////////
            /////////////////////////
        ...
        it('- should correctly validate an email attachment instance and throw appropriate errors when found (filename or content)', async () => {
          try {
            /////////////////////////
            //////// setup //////////
            /////////////////////////
      ...
      context('static data', () => {
        ...
        it('- should correctly validate an email attachment instance and throw appropriate errors when found', async () => {
          try {
            ...
            expect((validateResponse.value as any).content !== undefined).to.be.true;
            expect((validateResponse.value as any).content === EXPECTED_EMAIL_ATTACHEMENT.content).to.be.true;
            expect((validateResponse.value as any).contentType !== undefined).to.be.true;
            expect((validateResponse.value as any).contentType === EXPECTED_EMAIL_ATTACHEMENT.contentType).to.be.true;
        ...
        it('- should correctly validate an email attachment instance and throw appropriate errors when found (contentType)', async () => {
          try {
            /////////////////////////
            //////// setup //////////
            /////////////////////////
        ...
        it('- should correctly validate an email attachment instance and throw appropriate errors when found (filename, content, or contentType)', async () => {
          try {
            /////////////////////////
            //////// setup //////////
            /////////////////////////
      ...
      context('static data', () => {
        ...
        it('- should correctly validate an email attachment instance and throw appropriate errors when found', async () => {
          try {
            ...
            expect((validateResponse.value as any).content !== undefined).to.be.true;
            expect((validateResponse.value as any).content === EXPECTED_EMAIL_ATTACHEMENT.content).to.be.true;
            expect((validateResponse.value as any).encoding !== undefined).to.be.true;
            expect((validateResponse.value as any).encoding === EXPECTED_EMAIL_ATTACHEMENT.encoding).to.be.true;
        ...
        it('- should correctly validate an email attachment instance and throw appropriate errors when found (encoding)', async () => {
          try {
            /////////////////////////
            //////// setup //////////
            /////////////////////////
        ...
        it('- should correctly validate an email attachment instance and throw appropriate errors when found (filename, content, encoding)', async () => {
          try {
            /////////////////////////
            //////// setup //////////
            /////////////////////////
